...
<head>
    ...
    <title>Resized Image Table</title>
    <style>
        .image-table {
            width: 100%;
        ...
        .image-cell img {
            width: 100%;
            height: auto;
            max-width: 500px; /* Adjust this value to set the maximum width of each image */
        }
    </style>
</head>
<body>
    <table class="image-table">
        <tr>
            <td class="image-cell"><img src="images/time_over_hindi.png" alt="Tokenization Comparison Hindi"></td>
            <td class="image-cell"><img src="images/time_over_english.png" alt="Tokenization Comparison English"></td>
            <td class="image-cell"><img src="images/time_over_mandarin.png" alt="Tokenization Comparison Mandarin"></td>
        </tr>
    </table>
</body>
</html>
